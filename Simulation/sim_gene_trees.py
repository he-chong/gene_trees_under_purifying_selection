...
from sim_three_species_ancestral_selection_graph import CythonThreeSpeciesAncestralSelectionGraph
...
def runAParaList(repeat_num, tree_num_in_each_repeat, paraList, outDir):
    ...
    resultListList = []
    pool = multiprocessing.Pool(processes=int(multiprocessing.cpu_count()*0.5))  # Modify it to adjust the number of processes for running the simulation
